...
SELECT fam.rfam_acc family_accession_id, fam.description family_name, seq.length longest_dna_seq_length
FROM family AS fam
...
LIMIT 121, 135;  # Most probably there are not as many records so as to reach the 9th page! 
